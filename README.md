...
`web_search_tool.py` uses DuckDuckGo HTML search only. It does not require an
API key, Docker, public instance probing, or provider-specific
configuration. The tool preserves the query generated by the planner except for
