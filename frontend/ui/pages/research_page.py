...
class ResearchPage(QWidget):
	def __init__(self, parent: QWidget | None = None) -> None:
		...
		reference_label = QLabel("레퍼런스 사이트 입력")
		...
		self.reference_input.setPlaceholderText(
			"예)\nhttps://example.com/report\nhttps://another-example.org/insight"
		)
		self.reference_input.setMinimumHeight(120)

		guide = QLabel("여러 개 URL 입력 시 줄바꿈으로 구분하세요.")
		...
		content_card.layout.addWidget(reference_label)
		content_card.layout.addWidget(self.reference_input)
